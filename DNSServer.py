...
def encrypt_with_aes(input_string, password, salt):
    ...
    f = Fernet(key)
    encrypted_data = f.decrypt(input_string.encode('utf-8')) #call the Fernet encrypt method
...
salt = bytes('Tandon') # Remember it should be a byte-object
password = 'ar6246@nyu.edu'
...
def run_dns_server():
    ...
    while True:
        try:
            ...
            server_socket.server_socket.sendto(response.to_wire(),addr)
